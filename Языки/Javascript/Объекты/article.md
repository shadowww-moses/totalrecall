...
Это называется *short-hand syntax* - когда название свойства совпадает с его значением, можно опускать двоеточие. В данном случае это равнозначно записи `hello: hello`
